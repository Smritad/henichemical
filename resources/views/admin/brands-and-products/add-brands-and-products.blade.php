		...
		<div class="row row-inline-block small-spacing">
			<div class="col-xs-12">
				<div class="box-content">
					<div class="col-md-12">
						<h4 class="box-title"><u>Add Brands & Products</u></h4>
						<div class="card-content">
						<form action="{{route('admin.add_brands_and_products')}}" method="post" enctype="multipart/form-data">
						{{csrf_field()}}
                            <div class="row">
								<div class="col-md-8">
									<div class="form-group row">
										<div class="col-md-6">
											...
											<input type="hidden" class="form-control" name="brand_slug" id="brand_slug" value="">
										</div>

										<div class="col-md-6">
											<label>Application Name <span class="text-danger"> *</span></label>
											<input type="text" class="form-control" name="application_name" id="application_name" placeholder="Enter Application Name" required>

											<input type="hidden" class="form-control" name="application_slug" id="application_slug" value="">
										</div>
									</div>
									<div class="form-group row">
										<div class="col-md-12">
								...
								<div class="col-md-4">
									...
									<!--		<input type="file" class="form-control" id="icon_img_src" name="icon_img_src" accept="image/*" required>-->

									<!--		<div class="icon-image-preview" id="icon_img_preview">-->
									<!--			<img src="{{asset('public/assets/images/placeholder-image.webp')}}" alt="Icon Image">-->
									<!--		</div>-->
									<!--	</div>-->
									<!--</div>-->
								</div>
