<div class="card-content">
	<form action="{{route('admin.update_about_us_r_and_d')}}" method="post" enctype="multipart/form-data">
		{{csrf_field()}}
				...
				<div class="col-md-8">
					<div class="form-group row">
						<div class="col-md-12">
							...
							<textarea class="form-control editor" name="description" id="description" rows="5">{{$fetch_about_us_r_and_d_details->description}}</textarea>
				...
				<div class="col-md-4">
					<div class="form-group row">
						<div class="col-md-12">
							...
							<input type="hidden" name="old_img_src" value="{{$fetch_about_us_r_and_d_details->img_src}}">
							...
							<div class="image-preview" id="img_preview">
								<img src="{{asset('public/assets/images/about-us-r-and-d/'.$fetch_about_us_r_and_d_details->img_src)}}" alt="Image">
							</div>
						</div>
					</div>
				</div>
