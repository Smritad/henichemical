<div class="card-content">
	<form action="{{route('admin.update_career_page_details')}}" method="post" enctype="multipart/form-data">
		{{csrf_field()}}
		@if($fetch_career_page_details)
			<div class="row">
				<div class="col-md-8">
					<div class="form-group row">
						<div class="col-md-12">
							<label>Title One <span class="text-danger"> *</span></label>
							<input class="form-control" name="title_one" placeholder="Enter Title One" value="{{ $fetch_career_page_details->title_one }}" required>
						</div>
					</div>
					<div class="form-group row">
						<div class="col-md-12">
							<label>Title Two <span class="text-danger"> *</span></label>
							<input class="form-control" name="title_two" placeholder="Enter Title Two" value="{{ $fetch_career_page_details->title_two }}" required>
						</div>
					</div>
					<div class="form-group row">
						<div class="col-md-12">
							<label>Description <span class="text-danger"> *</span></label>
							<textarea class="form-control editor" name="description" id="description" rows="5">{{$fetch_career_page_details->description}}</textarea>
				...
				<div class="col-md-4">
					<div class="form-group row">
						<div class="col-md-12">
							...
							<input type="hidden" name="old_img_src" value="{{$fetch_career_page_details->img_src}}">
							...
							<div class="image-preview" id="img_preview">
								<img src="{{asset('public/assets/images/careers/'.$fetch_career_page_details->img_src)}}" alt="Image">
							</div>
						</div>
					</div>
				</div>
			...
			<div class="row">
				<div class="col-md-8">
					<div class="form-group row">
						<div class="col-md-12">
							<label>Title One <span class="text-danger"> *</span></label>
							<input class="form-control" name="title_one" placeholder="Enter Title One" required>
						</div>
					</div>
					<div class="form-group row">
						<div class="col-md-12">
							<label>Title Two <span class="text-danger"> *</span></label>
							<input class="form-control" name="title_two" placeholder="Enter Title Two" required>
						</div>
					</div>
					<div class="form-group row">
						<div class="col-md-12">
