		...
		<div class="row row-inline-block small-spacing">
			<div class="col-xs-12">
				<div class="box-content">
					<div class="col-md-12">
						<h4 class="box-title"><u>Edit Certificate</u></h4>
						<div class="card-content">
						<form action="{{route('admin.edit_certificate')}}" method="post" enctype="multipart/form-data">
						{{csrf_field()}}
                            <input type="hidden" name="certificate_id" value="{{$fetch_certificate_details->id}}">
							<div class="row">
								<div class="col-md-4">
									<div class="form-group row">
										<div class="col-md-12">
											...
											<input type="hidden" name="old_img_src" value="{{$fetch_certificate_details->img_src}}">
											...
											<div class="image-preview" id="img_preview">
												<img src="{{asset('public/assets/images/certificates/'.$fetch_certificate_details->img_src)}}" alt="Image">
											</div>
										</div>
									</div>
								</div>
