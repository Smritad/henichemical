...
<head>
    <meta charset="UTF-8">
    <title>New Enquiry - Heni Chemicals</title>
</head>
             ...
             style="max-width:140px; width:140px; height:auto; display:block;">
                ...
                <tr>
                    <td style="padding:25px; color:#333333; font-size:14px; line-height:22px;">
                        <p style="margin-top:0;"><strong>New Enquiry Received</strong></p>
                        ...
                        <table width="100%" cellpadding="0" cellspacing="0" style="margin-top:15px;">
                            ...
                            <tr>
                                ...
                                <td style="padding:8px 0;">{{ $user_subject }}</td>
                            </tr>
                            <tr>
                                <td style="padding:8px 0;"><strong>Message:</strong></td>
                                <td style="padding:8px 0;">{{ $user_message }}</td>
                            </tr>
                        </table>
                    </td>
                </tr>
