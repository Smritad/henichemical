...
<head>
    <meta charset="UTF-8">
    <title>Brochure - Heni Chemicals</title>
</head>
            ...
            <table width="600" cellpadding="0" cellspacing="0"
                ...
                <tr>
                    <td style="padding:25px; color:#333333; font-size:14px; line-height:22px;">
                        ...
                        <p>Your requested brochure <strong>{{ $title }}</strong> is attached to this email.</p>

                        <p>If you have any questions, feel free to contact us at <a href="mailto:sales@henichemicals.com">sales@henichemicals.com</a>.</p>

                        <p style="margin-top:20px;">Best regards,<br>Team Heni Chemicals</p>
                    </td>
                </tr>
